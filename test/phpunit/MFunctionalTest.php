...
/**
 * \file    test/phpunit/MFunctionalTest.php
 * \ingroup m
 ...
 * @package Testm
 */
class MFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/m/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('m/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/m/admin/about.php');
		$this->authenticate();
		return $this->assertContains('m/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modM_MTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modM_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
